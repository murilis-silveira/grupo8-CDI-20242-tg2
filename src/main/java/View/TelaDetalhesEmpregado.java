...
import model.dao.DetalhesEmpregadoDAO;
/**
 *
 * @author franc
 */
public class TelaDetalhesEmpregado extends javax.swing.JFrame {

    /**
     * Creates new form TelaDetalhesProduto
     */
    public TelaDetalhesEmpregado() {
        initComponents();
      ...
      public void count()
   {
         DetalhesEmpregadoDAO pdao = new DetalhesEmpregadoDAO();
      ...
      public void MaiorIdade()
   {
         DetalhesEmpregadoDAO pdao = new DetalhesEmpregadoDAO();
            ...
            for(Detalhes p: pdao.MaiorIdade())
         {
             txtCampo2.setText(p.getMaximo());                        
     ...
     public void MenorIdade()
   {
         DetalhesEmpregadoDAO pdao = new DetalhesEmpregadoDAO();
            ...
            for(Detalhes p: pdao.MenorIdade())
         {
             txtCampo3.setText(p.getMinimo());                        
     ...
     public void MediaIdade()
   {
         DetalhesEmpregadoDAO pdao = new DetalhesEmpregadoDAO();
            ...
            for(Detalhes p: pdao.MediaIdade())
         {
             txtCampo4.setText(p.getMedia());                        
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Total de Empregados");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDetalhesEmpregado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
